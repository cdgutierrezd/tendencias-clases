                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="nombre_tipo" placeholder="Por ejemplo, Administrador" autocomplete="off" value="{{ old('nombre_tipo', $tipoUsuario->nombre_tipo) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
